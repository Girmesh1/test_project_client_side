  ...
  return (
    ...
    <Card p={4} sx={{ maxWidth: 600, width: '100%' }}>
      ...
      <Box mb={3}>
        ...
        <Input id='title' name='title' onChange={(e) => setTitle(e.currentTarget.value)} value={title}  />
      </Box>

      <Box mb={3}>
        <Label htmlFor='genre'>Genre</Label>
        <Select id='genre' name='genre' defaultValue='select' onChange={(e) => setGenre(e.target.value)} value={genre}>
      ...
      <Box mb={3}>
        ...
        <Input id='artist' name='artist' onChange={(e) => setArtist(e.currentTarget.value)} value={artist} />
      </Box>
