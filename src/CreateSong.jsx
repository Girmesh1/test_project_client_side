    ...
    <Box sx={{ display: 'flex', justifyContent: 'center', alignItems: 'center', height: '100vh' }}>
      <Card p={4} sx={{ maxWidth: 600, width: '100%' }}>
        ...
        <Box mb={3}>
          ...
          <Select onChange={e => setGenre(e.target.value)} id='genre' name='genre' defaultValue='select'>
        ...
        <Box mb={3}>
          ...
          <Input id='title' name='title' onChange={(e) => setTitle(e.currentTarget.value)} />
        </Box>

        <Box mb={3}>
          <Label htmlFor='artist'>Artist</Label>
          <Input id='artist' name='artist' onChange={(e) => setArtist(e.currentTarget.value)} />
        </Box>

        <Box mb={3}>
          <Label htmlFor='album'>Album</Label>
          <Input id='album' name='album' onChange={(e) => setAlbum(e.currentTarget.value)} />
        </Box>

        <Box sx={{ display: 'flex', justifyContent: 'flex-end' }}>
          <Button  css={buttonStyles} onClick={addHandler}>
            Add Song
          </Button>
        </Box>
      </Card>
